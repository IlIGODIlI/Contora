...
import { timesData } from './times-data.js';
import { answers, showPage, showQuiz, onComplete } from './quiz.js';
import { generateIdeas, remixIdea, resetIdeaEngine } from './ideaEngine.js';
import { copyText, showToast } from './utils.js';

/* ============================================================
   1. STATE VARIABLES
   ============================================================ */
export let strategyData = null;
export let resolvedNiche = '';
...
/* ============================================================
   ...
   ============================================================ */
export async function genStrategy() {
  showPage('loading');
  ...
  const fallback = {
    ...
    cta: answers.goal && answers.goal.includes('money')
...
/* ============================================================
   ...
   ============================================================ */
export function buildResult(s, niche) {
  showPage('result');
  switchTab('strategy');
  window._hist = [];
...
/* ============================================================
   ...
   ============================================================ */
export function buildSaveSection(s, niche) {
...
/* ============================================================
   ...
   ============================================================ */
export function buildIdeasTab(niche, append) {
  if (!append) {
    resetIdeaEngine();
    window._ideasNiche = niche;
  }
  const n = window._ideasNiche || niche;
  const batch = generateIdeas(n, 5, window._ua?.platform);
